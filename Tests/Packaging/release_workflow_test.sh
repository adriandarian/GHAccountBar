...
rg -q 'runs-on: macos-26' "$WORKFLOW" || fail "workflow does not use the Swift 6.3-capable arm64 runner"
rg -q 'DEVELOPER_DIR: /Applications/Xcode_26\.6\.app/Contents/Developer' "$WORKFLOW" || fail "workflow does not select the Swift 6.3 toolchain"
